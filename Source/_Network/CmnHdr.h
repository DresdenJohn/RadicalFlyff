...
enum 
{	
	SM_BANK15, SM_BANK30, SM_PARTYSKILL15, SM_PARTYSKILL30, SM_SHOUT15, SM_SHOUT30, SM_SHOUT3, SM_SHOUT7,
...
//		memset( nValue, 0, sizeof( int ) * SM_MAX );
		...
		bSMModetime[SM_SHOUT3] = TRUE;
		bSMModetime[SM_SHOUT7] = TRUE;
		...
		dwSMItemID[SM_SHOUT3] = II_CHR_SYS_SCR_SHOUTFULL3;
		dwSMItemID[SM_SHOUT7] = II_CHR_SYS_SCR_SHOUTFULL7;
