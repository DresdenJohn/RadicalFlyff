...
#define __SHOW_ALL_STATS // Detailed character info
...
#define __NEW_CS_SHOP //Needs DB Fixed
#define __NEW_AA_SYSTEM // Checks GPU for highest Anti Aliasing type and renders with it
