...
#define COLOR_GAMEMASTER        0xffffffff	//0xff2D7CAE	//rev1
#define COLOR_ADMINISTRATOR     0xffffffff	//0xffAE2D2D	//" "
...
//	virtual int		OnActCollecting();				// User만 사용되는 것이므로 CUser가서 찾을것.
	...
	void			InitLevel( int nJob, LONG nLevel, BOOL bGamma = TRUE );			// 객체를 nLevel로 바꿔줌
 	...
 	void			InitLevelJobChange( int nJob, LONG nLevel, BOOL bGamma = TRUE ) ;
